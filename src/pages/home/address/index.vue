<template>
    <div class="page">
            ...
            <template v-show="address.length>0">
                <div :key="index"
                    ...
                    <div class='handle-wrap'>
                        ...
                        <div @click="isusual(index,item.userAddressID)" class="ismoren">
                            <div style="
							display: flex;align-items: center;" v-if="item.usual===0">
                        ...
                        <div class="button-address">
                            <div @click.stop="gotothexiugai(item)" class='edit'>修改</div>
                            <div @click.stop="delAddress(item.userAddressID)" class='del'>删除</div>
                        </div>
                    </div>
                </div>
            </template>
        ...
        <div @click="$router.push('/address/add')" class='address-nav-name-2'>
