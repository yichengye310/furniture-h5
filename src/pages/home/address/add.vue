<template>
    <div class="page">
        ...
        <div class='main'>
            ...
            <ul>
                <li>详细地址</li>
                <li><input type="text" placeholder="街道详细地址" v-model="address123" /></li>
            </ul>
			<ul>
			    <li>设为默认地址</li>
			    <li style="display: flex;align-items: center;justify-content:flex-end;">
					<van-switch v-model="checked" inactive-color="#ffffff" active-color="#07c160" size="18px"/></li>
			</ul>
			
            <button type="button" class='submit-save' @click="submit($event)">保存</button>
        </div>
