<template>
    <div class="page">
        <SubHeader @submit="submit()" title="更改密码"></SubHeader>
        <div class="main">
            <div class="cellphone-wrap">
                <div class="cellphone tubiaoz">
                    <input @input="checkCellphone" maxlength="11" placeholder="请输入手机号" type="tel"
                           v-model="phoneNumber"/>
                </div>
            </div>
            <div class="code-wrap cellphone-wrap cellphone-wrap2">
                <div class="tubiaoz">
                    <input placeholder="请输入验证码" type="text" v-model="validCode"/>
                </div>
                <div :class="{'code-btn':true, success:isSendMsgCode}" @click="getMsgCode">{{msgCodeText}}</div>
            </div>
            <div class="password-wrap">
                <div class="password tubiaoz">
                    <input :type="isOpen?'text':'password'" maxlength="16" placeholder="请输入新密码" v-model="password"/>
                </div>
                <div
                        class="switch-wrap"
                        style="display: flex;
			...
			justify-content: center;"
                >
                    <div @click="isOpen = !isOpen" style="width: 0.34rem;height: 0.22rem;">
