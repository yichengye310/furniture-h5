<template>
    <div class="page">
        ...
        <div class='main'>
            <div class='list' v-for="(item,index) in address" 
			:key="index" @click="$router.push('/user/address/mod?aid='+item.aid)">
                <div class='name-wrap'>
...
<style scoped>
    ...
    .list .address span{color:#000000}
    .list .right-arrow{
		width:0.3rem;
		height:0.3rem;
    ...
    .add-btn{width:80%;height:0.8rem;background-color:#000000;position: fixed;z-index:2;bottom:0.4rem;left:50%;border-radius: 4px;transform: translateX(-50%);-webkit-transform: translateX(-50%);color:#FFFFFF;font-size:0.28rem;text-align:center;line-height:0.8rem;}
</style>
