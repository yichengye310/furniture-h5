...
<<<<<<< HEAD
					...
					readOnly :value="showArea" @click="isArea=true" />
=======
...
<<<<<<< HEAD
            ...
            <ul>
                <li>设置为默认地址</li>
                <li class="caixukun"><van-switch v-model="isDefault" active-color="#000000" /></li>
            </ul>
...
<<<<<<< HEAD
    import {Toast,Area,Popup,Switch} from "vant";
...
<<<<<<< HEAD
	...
	.main ul .caixukun{display: flex;align-items: center;}
    ...
    .main .submit-save{
		...
		right: 0;
		left: 0;
		width:85%;height:0.8rem;background-color:#000000;border-radius: 4px;margin:0 auto;display:block;border:0 none;outline:none;font-size:0.32rem;color:#FFFFFF;margin-top:0.4rem;}
=======
    .page {
        width: 100%;
        height: 100vh;
